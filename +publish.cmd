...
for %%n in (!SEL!) do (
    ...
    if "%%n"=="16"  call :pub "Code.Idle"              "Games\Idle\Code.Idle"                                    "Code.Idle.exe"             "Games\Idle"
    ...
    if "%%n"=="22"  call :pub "Data.Map"               "Applications\Data\Data.Map"                              "Data.Map.exe"              "Applications\Data\Data.Map"
    ...
    if "%%n"=="39"  call :pub "Geo.Quiz"               "Games\Casual\Geo.Quiz"                                   "Geo.Quiz.exe"              "Games\Casual"
    ...
    if "%%n"=="42"  call :pub "Golf.Cast"              "Games\Sports\Golf.Cast"                                  "Golf.Cast.exe"             "Games\Sports"
    ...
    if "%%n"=="50"  call :pub "Img.Cast"             "Applications\Emoji.Icon\Img.Cast"                      "Img.Cast.exe"              "Applications\Emoji.Icon\Img.Cast"
    ...
    if "%%n"=="55"  call :pub "Key.Test"               "Applications\System\Key\Key.Test"                        "KeyTest.exe"               "Applications\System\Key\KeyTest"
    if "%%n"=="56"  call :pub "Leaf.Grow"              "Games\Simulation\Leaf.Grow"                              "Leaf.Grow.exe"             "Games\Simulation"
    if "%%n"=="57"  call :pub "Locale.View"            "Applications\Development\Inspector\Locale.View"          "Locale.View.exe"           "Applications\Development\Inspector"
    ...
    if "%%n"=="64"  call :pub "Morse.Run"              "Games\Casual\Morse.Run"                                  "Morse.Run.exe"             "Games\Casual"
    ...
    if "%%n"=="66"  call :pub "Mouse.Flick"            "Applications\Tools.Utility\Mouse.Flick"                  "Mouse.Flick.exe"           "Applications\Tools.Utility\Mouse.Flick"
    ...
    if "%%n"=="109" call :pub "Word.Cloud"             "Applications\Text\Word.Cloud"                            "Word.Cloud.exe"            "Applications\Text\Word.Cloud"
...
call :pub "Key.Test"              "Applications\System\Key\Key.Test"                        "KeyTest.exe"               "Applications\System\Key\KeyTest"
...
call :pub "Word.Cloud"            "Applications\Text\Word.Cloud"                            "Word.Cloud.exe"            "Applications\Text\Word.Cloud"
...
call :pub "Mouse.Flick"           "Applications\Tools.Utility\Mouse.Flick"                  "Mouse.Flick.exe"           "Applications\Tools.Utility\Mouse.Flick"
