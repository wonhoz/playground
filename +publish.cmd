...
echo !CY!  20!RS! Echo.Text             !DG!Applications/Text!RS!
echo !CY!  21!RS! Env.Guard             !DG!Applications/System!RS!
...
echo !CY!  25!RS! Glyph.Map             !DG!Applications/Emoji.Icon!RS!
echo !CY!  26!RS! Gravity.Flip          !DG!Games/Puzzle!RS!
echo !CY!  27!RS! Hash.Check            !DG!Files/Inspector!RS!
echo !CY!  28!RS! Hex.Peek              !DG!Applications/Development!RS!
echo !CY!  29!RS! Hook.Cast             !DG!Games/Casual!RS!
echo !CY!  30!RS! Hue.Flow              !DG!Games/Puzzle!RS!
echo !CY!  31!RS! Icon.Hunt             !DG!Applications/Emoji.Icon!RS!
echo !CY!  32!RS! Key.Map               !DG!Applications/System!RS!
echo !CY!  33!RS! Leaf.Grow             !DG!Games/Simulation!RS!
echo !CY!  34!RS! Log.Lens              !DG!Applications/Development!RS!
echo !CY!  35!RS! Mark.View             !DG!Applications/Text!RS!
echo !CY!  36!RS! Mock.Server           !DG!Applications/Network!RS!
echo !CY!  37!RS! Mosaic.Forge          !DG!Applications/Photo.Picture!RS!
echo !CY!  38!RS! Mouse.Flick           !DG!Applications/Tools.Utility!RS!
echo !CY!  39!RS! Music.Player          !DG!Applications/Audio!RS!
echo !CY!  40!RS! Neon.Run              !DG!Games/Arcade!RS!
echo !CY!  41!RS! Neon.Slice            !DG!Games/Arcade!RS!
echo !CY!  42!RS! Net.Scan              !DG!Applications/Network!RS!
echo !CY!  43!RS! Nitro.Drift           !DG!Games/Racing!RS!
echo !CY!  44!RS! Orbit.Craft           !DG!Games/Puzzle!RS!
echo !CY!  45!RS! PDF.Forge             !DG!Files/Inspector!RS!
echo !CY!  46!RS! Photo.Video.Organizer !DG!Applications/Photo.Picture!RS!
echo !CY!  47!RS! Port.Watch            !DG!Applications/Network!RS!
echo !CY!  48!RS! Prompt.Forge          !DG!Applications/AI!RS!
echo !CY!  49!RS! QR.Forge              !DG!Applications/Tools.Utility!RS!
echo !CY!  50!RS! Quick.Calc            !DG!Applications/Development!RS!
echo !CY!  51!RS! Sand.Fall             !DG!Games/Sandbox!RS!
echo !CY!  52!RS! Sched.Cast            !DG!Applications/System!RS!
echo !CY!  53!RS! Screen.Recorder       !DG!Applications/Video!RS!
...
for %%n in (!SEL!) do (
    ...
    if "%%n"=="20" call :pub "Echo.Text"              "Applications\Text\Echo.Text"                            "Echo.Text.exe"             "Applications\Text\Echo.Text"
    if "%%n"=="21" call :pub "Env.Guard"              "Applications\System\Env.Guard"                          "Env.Guard.exe"             "Applications\System"
    ...
    if "%%n"=="25" call :pub "Glyph.Map"              "Applications\Emoji.Icon\Glyph.Map"                      "Glyph.Map.exe"             "Applications\Emoji.Icon\Glyph.Map"
    ...
    if "%%n"=="28" call :pub "Hex.Peek"               "Applications\Development\Hex.Peek"                      "Hex.Peek.exe"              "Applications\Development"
    ...
    if "%%n"=="31" call :pub "Icon.Hunt"              "Applications\Emoji.Icon\Icon.Hunt"                      "Icon.Hunt.exe"             "Applications\Emoji.Icon"
    if "%%n"=="32" call :pub "Key.Map"                "Applications\System\Key.Map"                            "Key.Map.exe"               "Applications\System\Key.Map"
    if "%%n"=="33" call :pub "Leaf.Grow"              "Games\Simulation\Leaf.Grow"                             "Leaf.Grow.exe"             "Games\Simulation"
    if "%%n"=="34" call :pub "Log.Lens"               "Applications\Development\Log.Lens"                      "Log.Lens.exe"              "Applications\Development"
    if "%%n"=="35" call :pub "Mark.View"              "Applications\Text\Mark.View"                            "Mark.View.exe"             "Applications\Text\Mark.View"
    if "%%n"=="36" call :pub "Mock.Server"            "Applications\Network\Mock.Server"                       "Mock.Server.exe"           "Applications\Network"
    if "%%n"=="37" call :pub "Mosaic.Forge"           "Applications\Photo.Picture\Mosaic.Forge"                "Mosaic.Forge.exe"          "Applications\Photo.Picture\Mosaic.Forge"
    if "%%n"=="38" call :pub "Mouse.Flick"            "Applications\Tools.Utility\Mouse.Flick"                 "Mouse.Flick.exe"           "Applications\Tools.Utility"
    if "%%n"=="39" call :pub "Music.Player"           "Applications\Audio\Music.Player"                        "Music.Player.exe"          "Applications\Audio"
    if "%%n"=="40" call :pub "Neon.Run"               "Games\Arcade\Neon.Run"                                  "Neon.Run.exe"              "Games\Arcade"
    if "%%n"=="41" call :pub "Neon.Slice"             "Games\Arcade\Neon.Slice"                                "Neon.Slice.exe"            "Games\Arcade\Neon.Slice"
    if "%%n"=="42" call :pub "Net.Scan"               "Applications\Network\Net.Scan"                          "Net.Scan.exe"              "Applications\Network\Net.Scan"
    if "%%n"=="43" call :pub "Nitro.Drift"            "Games\Racing\Nitro.Drift"                               "Nitro.Drift.exe"           "Games\Racing"
    if "%%n"=="44" call :pub "Orbit.Craft"            "Games\Puzzle\Orbit.Craft"                               "Orbit.Craft.exe"           "Games\Puzzle\Orbit.Craft"
    if "%%n"=="45" call :pub "PDF.Forge"              "Applications\Files\Inspector\PDF.Forge"                 "Pdf.Forge.exe"             "Applications\Files\Inspector\Pdf.Forge"
    if "%%n"=="46" call :pub "Photo.Video.Organizer"  "Applications\Photo.Picture\Photo.Video.Organizer"       "Photo.Video.Organizer.exe" "Applications\Photo.Picture"
    if "%%n"=="47" call :pub "Port.Watch"             "Applications\Network\Port.Watch"                        "Port.Watch.exe"            "Applications\Network"
    if "%%n"=="48" call :pub "Prompt.Forge"           "Applications\AI\Prompt.Forge"                           "Prompt.Forge.exe"          "Applications\AI\Prompt.Forge"
    if "%%n"=="49" call :pub "QR.Forge"               "Applications\Tools.Utility\QR.Forge"                    "QR.Forge.exe"              "Applications\Tools.Utility"
    if "%%n"=="50" call :pub "Quick.Calc"             "Applications\Development\Quick.Calc"                    "Quick.Calc.exe"            "Applications\Development"
    if "%%n"=="51" call :pub "Sand.Fall"              "Games\Sandbox\Sand.Fall"                                "Sand.Fall.exe"             "Games\Sandbox"
    if "%%n"=="52" call :pub "Sched.Cast"             "Applications\System\Sched.Cast"                         "Sched.Cast.exe"            "Applications\System\Sched.Cast"
    if "%%n"=="53" call :pub "Screen.Recorder"        "Applications\Video\Screen.Recorder"                     "Screen.Recorder.exe"       "Applications\Video"
