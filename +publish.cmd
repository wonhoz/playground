...
echo !CY!  18!RS! Port.Watch            !DG!Tools/Network!RS!
echo.
echo !BD!!DG!  Tools / Productivity!RS!
echo !CY!  19!RS! Clipboard.Stacker     !DG!Tools/Productivity!RS!
echo !CY!  20!RS! Screen.Recorder       !DG!Tools/Productivity!RS!
echo !CY!  21!RS! QR.Forge              !DG!Tools/Productivity!RS!
echo !CY!  22!RS! Text.Forge            !DG!Tools/Productivity!RS!
...
echo !CY!  28!RS! Brick.Blitz           !DG!Games/Arcade!RS!
...
echo !CY!  37!RS! Star.Strike           !DG!Games/Shooter!RS!
echo !CY!  38!RS! Tower.Guard           !DG!Games/Strategy!RS!
echo.
echo !DG!--------------------------------------------------!RS!
...
for %%n in (!SEL!) do (
    ...
    if "%%n"=="5"  call :pub "Disk.Lens"              "Applications\Files\Disk.Lens"                      "Disk.Lens.exe"            "Applications\Files"
    ...
    if "%%n"=="20" call :pub "Screen.Recorder"        "Applications\Tools\Productivity\Screen.Recorder"   "Screen.Recorder.exe"      "Applications\Tools\Productivity"
    if "%%n"=="21" call :pub "QR.Forge"               "Applications\Tools\Productivity\QR.Forge"          "QR.Forge.exe"             "Applications\Tools\Productivity"
    if "%%n"=="22" call :pub "Text.Forge"             "Applications\Tools\Productivity\Text.Forge"        "Text.Forge.exe"           "Applications\Tools\Productivity"
    ...
    if "%%n"=="37" call :pub "Star.Strike"            "Games\Shooter\Star.Strike"                         "Star.Strike.exe"          "Games\Shooter"
    if "%%n"=="38" call :pub "Tower.Guard"            "Games\Strategy\Tower.Guard"                        "Tower.Guard.exe"          "Games\Strategy"
)
goto :DONE
...
call :pub "Disk.Lens"             "Applications\Files\Disk.Lens"                      "Disk.Lens.exe"            "Applications\Files"
