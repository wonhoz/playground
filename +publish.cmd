...
for %%n in (!SEL!) do (
    ...
    if "%%n"=="9"  call :pub "Hash.Check"             "Applications\Files\Inspector\Hash.Check"                   "Hash.Check.exe"            "Applications\Files\Inspector\Hash.Check"
    if "%%n"=="10" call :pub "PDF.Forge"              "Applications\Files\Inspector\PDF.Forge"                    "Pdf.Forge.exe"             "Applications\Files\Inspector\Pdf.Forge"
    if "%%n"=="11" call :pub "Zip.Peek"               "Applications\Files\Inspector\Zip.Peek"                     "Zip.Peek.exe"              "Applications\Files\Inspector\Zip.Peek"
    ...
    if "%%n"=="21" call :pub "Icon.Hunt"              "Applications\Tools\Dev\Assets\Icon.Hunt"                   "Icon.Hunt.exe"             "Applications\Tools\Dev\Assets"
    if "%%n"=="22" call :pub "Key.Map"                "Applications\Tools\Dev\Assets\Key.Map"                     "Key.Map.exe"               "Applications\Tools\Dev\Assets\Key.Map"
    if "%%n"=="23" call :pub "Locale.Forge"           "Applications\Tools\Dev\Assets\Locale.Forge"                "Locale.Forge.exe"          "Applications\Tools\Dev\Assets"
    if "%%n"=="24" call :pub "Boot.Map"               "Applications\Tools\Dev\Data\Boot.Map"                      "Boot.Map.exe"              "Applications\Tools\Dev\Data"
    ...
    if "%%n"=="29" call :pub "Net.Scan"               "Applications\Tools\Network\Net.Scan"                       "Net.Scan.exe"              "Applications\Tools\Network\Net.Scan"
    ...
    if "%%n"=="33" call :pub "Echo.Text"              "Applications\Tools\Productivity\Text\Echo.Text"            "Echo.Text.exe"             "Applications\Tools\Productivity\Text\Echo.Text"
    ...
    if "%%n"=="37" call :pub "Timeline.Craft"         "Applications\Tools\Productivity\Visual\Timeline.Craft"     "Timeline.Craft.exe"        "Applications\Tools\Productivity\Visual\Timeline.Craft"
    ...
    if "%%n"=="48" call :pub "Tray.Stats"             "Applications\Tools\System\Tray.Stats"                      "Tray.Stats.exe"            "Applications\Tools\System\Tray.Stats"
    if "%%n"=="49" call :pub "Mosaic.Forge"           "Applications\Media\Mosaic.Forge"                           "Mosaic.Forge.exe"          "Applications\Media\Mosaic.Forge"
