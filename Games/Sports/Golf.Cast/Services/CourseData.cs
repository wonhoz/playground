...
public static class CourseData
{
    ...
    private static CourseSet BuildEasy() => new()
    {
        ...
        Holes =
        [
            MakeSimpleHole(1, 2, "직선 퍼팅",        tee: new(80,  300), hole: new(580, 300),
                wallPairs: [((80, 260),(580, 260)),((580, 260),(580, 340)),((580, 340),(80, 340)),((80, 340),(80, 260))]),

            MakeSimpleHole(2, 2, "L자 코스",         tee: new(80,  200), hole: new(500, 450),
            ...
            MakeSimpleHole(3, 3, "모래 구덩이",      tee: new(80,  300), hole: new(600, 300),
                wallPairs: [((80,260),(600,260)),((600,260),(600,340)),((600,340),(80,340)),((80,340),(80,260))],
                sandRects: [(200, 260, 100, 80), (400, 260, 100, 80)]),

            MakeSimpleHole(4, 2, "곡선 터널",        tee: new(80,  400), hole: new(560, 160),
            ...
            MakeSimpleHole(5, 3, "물 해자",          tee: new(80,  300), hole: new(600, 300),
                wallPairs: [((80,260),(600,260)),((600,260),(600,340)),((600,340),(80,340)),((80,340),(80,260))],
                waterRects: [(280, 265, 80, 70)]),

            MakeSimpleHole(6, 2, "풍차 통과",        tee: new(80, 300), hole: new(600, 300),
                wallPairs: [((80,260),(600,260)),((600,260),(600,340)),((600,340),(80,340)),((80,340),(80,260))],
                windmill: new Vec2(340, 300)),

            MakeSimpleHole(7, 3, "S자 루트",         tee: new(80, 480), hole: new(560, 100),
            ...
            MakeSimpleHole(8, 2, "귀퉁이 반사",      tee: new(80, 480), hole: new(560, 80),
                wallPairs: [((80,440),(600,440)),((600,440),(600,40)),((600,40),(80,40)),((80,40),(80,440))],
                innerWalls: [((200,40),(200,350)),((400,130),(400,440))]),

            MakeSimpleHole(9, 4, "미로 코스",        tee: new(80, 500), hole: new(580, 80),
            ...
            MakeSimpleHole(17, 4, "풍차 + 물",     tee: new(80, 300), hole: new(600, 300),
                wallPairs: [((80,220),(600,220)),((600,220),(600,380)),((600,380),(80,380)),((80,380),(80,220))],
                windmill: new Vec2(260, 300), waterRects: [(380, 225, 100, 150)]),

            MakeSimpleHole(18, 5, "마지막 도전",    tee: new(80, 500), hole: new(580, 80),
                wallPairs: [((80,460),(600,460)),((600,460),(600,40)),((600,40),(80,40)),((80,40),(80,460))],
