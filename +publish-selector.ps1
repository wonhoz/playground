...
$allApps = @(
    ...
    [pscustomobject]@{N=15;  Name="Circuit.Break";         Cat="Games/Puzzle"}
    [pscustomobject]@{N=16;  Name="Clipboard.Stacker";     Cat="Applications/Tools.Utility"}
    [pscustomobject]@{N=17;  Name="Code.Idle";             Cat="Games/Idle"}
    [pscustomobject]@{N=18;  Name="Color.Grade";           Cat="Applications/Photo.Picture"}
    [pscustomobject]@{N=19;  Name="Comic.Cast";            Cat="Applications/Photo.Picture"}
    [pscustomobject]@{N=20;  Name="Crossword.Cast";        Cat="Games/Puzzle"}
    [pscustomobject]@{N=21;  Name="Ctx.Menu";              Cat="Applications/System/Manager"}
    [pscustomobject]@{N=22;  Name="Dash.City";             Cat="Games/Arcade"}
