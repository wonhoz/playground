...
public static class MaterialDef
{
    ...
    public static readonly uint[] BaseColor = new uint[(int)Material.Ash + 1]
    {
    ...
    public static readonly MatCategory[] Category = new MatCategory[(int)Material.Ash + 1]
    {
    ...
    public static bool IsFlammable(Material m) =>
        m is Material.Wood or Material.Oil or Material.Plant or Material.Seed;
