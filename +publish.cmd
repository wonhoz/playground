...
echo !CY!  31!RS! Git.Stats             !DG!Applications/Development/Analyzer!RS!
echo !CY!  32!RS! Glyph.Map             !DG!Applications/Emoji.Icon!RS!
echo !CY!  33!RS! Gravity.Flip          !DG!Games/Puzzle!RS!
echo !CY!  34!RS! Hash.Check            !DG!Applications/Files/Inspector!RS!
echo !CY!  35!RS! Hex.Peek              !DG!Applications/Development/Inspector!RS!
echo !CY!  36!RS! Hook.Cast             !DG!Games/Casual!RS!
echo !CY!  37!RS! Hue.Flow              !DG!Games/Puzzle!RS!
echo !CY!  38!RS! Icon.Hunt             !DG!Applications/Emoji.Icon!RS!
echo !CY!  39!RS! Key.Map               !DG!Applications/System/Manager!RS!
echo !CY!  40!RS! Key.Test              !DG!Applications/System/Manager!RS!
echo !CY!  41!RS! Leaf.Grow             !DG!Games/Simulation!RS!
echo !CY!  42!RS! Log.Lens              !DG!Applications/Development/Analyzer!RS!
echo !CY!  43!RS! Log.Merge             !DG!Applications/Development/Analyzer!RS!
echo !CY!  44!RS! Mark.View             !DG!Applications/Text!RS!
echo !CY!  45!RS! Mem.Lens              !DG!Applications/System/Monitor!RS!
echo !CY!  46!RS! Mock.Server           !DG!Applications/Network/Server!RS!
...
echo !CY!  52!RS! Net.Scan              !DG!Applications/Network/Monitor!RS!
echo !CY!  53!RS! Nitro.Drift           !DG!Games/Racing!RS!
echo !CY!  54!RS! Orbit.Craft           !DG!Games/Puzzle!RS!
echo !CY!  55!RS! Path.Guard            !DG!Applications/System/Manager!RS!
echo !CY!  56!RS! PDF.Forge             !DG!Applications/Files/Inspector!RS!
echo !CY!  57!RS! Photo.Video.Organizer !DG!Applications/Photo.Picture!RS!
echo !CY!  58!RS! Port.Watch            !DG!Applications/Network/Monitor!RS!
echo !CY!  59!RS! Prompt.Forge          !DG!Applications/AI!RS!
echo !CY!  60!RS! QR.Forge              !DG!Applications/Tools.Utility!RS!
echo !CY!  61!RS! Quick.Calc            !DG!Applications/Development/Inspector!RS!
echo !CY!  62!RS! Reg.Vault             !DG!Applications/System/Manager!RS!
echo !CY!  63!RS! Sand.Fall             !DG!Games/Sandbox!RS!
echo !CY!  64!RS! Sched.Cast            !DG!Applications/System/Manager!RS!
echo !CY!  65!RS! Screen.Recorder       !DG!Applications/Video!RS!
echo !CY!  66!RS! Serve.Cast            !DG!Applications/Network/Server!RS!
echo !CY!  67!RS! Shortcut.Forge        !DG!Applications/Files/Manager!RS!
echo !CY!  68!RS! Signal.Flow           !DG!Applications/Development/Inspector!RS!
echo !CY!  69!RS! Sky.Drift             !DG!Games/Arcade!RS!
echo !CY!  70!RS! Spec.Report           !DG!Applications/System/Monitor!RS!
echo !CY!  71!RS! Spec.View             !DG!Applications/System/Monitor!RS!
...
for %%n in (!SEL!) do (
    ...
    if "%%n"=="31" call :pub "Git.Stats"              "Applications\Development\Analyzer\Git.Stats"                "Git.Stats.exe"             "Applications\Development\Analyzer"
    if "%%n"=="32" call :pub "Glyph.Map"              "Applications\Emoji.Icon\Glyph.Map"                          "Glyph.Map.exe"             "Applications\Emoji.Icon\Glyph.Map"
    if "%%n"=="33" call :pub "Gravity.Flip"           "Games\Puzzle\Gravity.Flip"                                  "Gravity.Flip.exe"          "Games\Puzzle"
    if "%%n"=="34" call :pub "Hash.Check"             "Applications\Files\Inspector\Hash.Check"                    "Hash.Check.exe"            "Applications\Files\Inspector\Hash.Check"
    if "%%n"=="35" call :pub "Hex.Peek"               "Applications\Development\Inspector\Hex.Peek"                "Hex.Peek.exe"              "Applications\Development\Inspector"
    if "%%n"=="36" call :pub "Hook.Cast"              "Games\Casual\Hook.Cast"                                     "Hook.Cast.exe"             "Games\Casual"
    if "%%n"=="37" call :pub "Hue.Flow"               "Games\Puzzle\Hue.Flow"                                      "Hue.Flow.exe"              "Games\Puzzle"
    if "%%n"=="38" call :pub "Icon.Hunt"              "Applications\Emoji.Icon\Icon.Hunt"                          "Icon.Hunt.exe"             "Applications\Emoji.Icon"
    if "%%n"=="39" call :pub "Key.Map"                "Applications\System\Manager\Key.Map"                        "Key.Map.exe"               "Applications\System\Manager\Key.Map"
    if "%%n"=="40" call :pub "Key.Test"               "Applications\System\Manager\Key.Test"                       "KeyTest.exe"               "Applications\System\Manager"
    if "%%n"=="41" call :pub "Leaf.Grow"              "Games\Simulation\Leaf.Grow"                                 "Leaf.Grow.exe"             "Games\Simulation"
    if "%%n"=="42" call :pub "Log.Lens"               "Applications\Development\Analyzer\Log.Lens"                 "Log.Lens.exe"              "Applications\Development\Analyzer"
    if "%%n"=="43" call :pub "Log.Merge"              "Applications\Development\Analyzer\Log.Merge"                "Log.Merge.exe"             "Applications\Development\Analyzer"
    if "%%n"=="44" call :pub "Mark.View"              "Applications\Text\Mark.View"                                "Mark.View.exe"             "Applications\Text\Mark.View"
    if "%%n"=="45" call :pub "Mem.Lens"               "Applications\System\Monitor\Mem.Lens"                       "MemLens.exe"               "Applications\System\Monitor"
    if "%%n"=="46" call :pub "Mock.Server"            "Applications\Network\Server\Mock.Server"                    "Mock.Server.exe"           "Applications\Network\Server"
    ...
    if "%%n"=="52" call :pub "Net.Scan"               "Applications\Network\Monitor\Net.Scan"                      "Net.Scan.exe"              "Applications\Network\Monitor\Net.Scan"
    ...
    if "%%n"=="55" call :pub "Path.Guard"             "Applications\System\Manager\Path.Guard"                     "PathGuard.exe"             "Applications\System\Manager"
    if "%%n"=="56" call :pub "PDF.Forge"              "Applications\Files\Inspector\PDF.Forge"                     "Pdf.Forge.exe"             "Applications\Files\Inspector\Pdf.Forge"
    if "%%n"=="57" call :pub "Photo.Video.Organizer"  "Applications\Photo.Picture\Photo.Video.Organizer"           "Photo.Video.Organizer.exe" "Applications\Photo.Picture"
    if "%%n"=="58" call :pub "Port.Watch"             "Applications\Network\Monitor\Port.Watch"                    "Port.Watch.exe"            "Applications\Network\Monitor"
    if "%%n"=="59" call :pub "Prompt.Forge"           "Applications\AI\Prompt.Forge"                               "Prompt.Forge.exe"          "Applications\AI\Prompt.Forge"
    if "%%n"=="60" call :pub "QR.Forge"               "Applications\Tools.Utility\QR.Forge"                        "QR.Forge.exe"              "Applications\Tools.Utility"
    if "%%n"=="61" call :pub "Quick.Calc"             "Applications\Development\Inspector\Quick.Calc"              "Quick.Calc.exe"            "Applications\Development\Inspector"
    if "%%n"=="62" call :pub "Reg.Vault"              "Applications\System\Manager\Reg.Vault"                      "RegVault.exe"              "Applications\System\Manager"
    if "%%n"=="63" call :pub "Sand.Fall"              "Games\Sandbox\Sand.Fall"                                    "Sand.Fall.exe"             "Games\Sandbox"
    if "%%n"=="64" call :pub "Sched.Cast"             "Applications\System\Manager\Sched.Cast"                     "Sched.Cast.exe"            "Applications\System\Manager\Sched.Cast"
    if "%%n"=="65" call :pub "Screen.Recorder"        "Applications\Video\Screen.Recorder"                         "Screen.Recorder.exe"       "Applications\Video"
    if "%%n"=="66" call :pub "Serve.Cast"             "Applications\Network\Server\Serve.Cast"                     "Serve.Cast.exe"            "Applications\Network\Server"
    if "%%n"=="67" call :pub "Shortcut.Forge"         "Applications\Files\Manager\Shortcut.Forge"                  "ShortcutForge.exe"         "Applications\Files\Manager"
    if "%%n"=="68" call :pub "Signal.Flow"            "Applications\Development\Inspector\Signal.Flow"             "Signal.Flow.exe"           "Applications\Development\Inspector"
    if "%%n"=="69" call :pub "Sky.Drift"              "Games\Arcade\Sky.Drift"                                     "SkyDrift.exe"              "Games\Arcade"
    if "%%n"=="70" call :pub "Spec.Report"            "Applications\System\Monitor\Spec.Report"                    "Spec.Report.exe"           "Applications\System\Monitor"
    if "%%n"=="71" call :pub "Spec.View"              "Applications\System\Monitor\Spec.View"                      "Spec.View.exe"             "Applications\System\Monitor\Spec.View"
