...
{
    private static readonly Color BgColor = Color.FromArgb(28, 28, 42);
    private static readonly Color HoverColor = Color.FromArgb(50, 50, 72);
    ...
    private static readonly Color CheckColor = Color.FromArgb(64, 160, 255);
...
{
    private static readonly Color Bg = Color.FromArgb(28, 28, 42);
    private static readonly Color Bd = Color.FromArgb(55, 55, 75);
    private static readonly Color Sel = Color.FromArgb(50, 50, 72);
